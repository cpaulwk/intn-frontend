...
const Sidebar: React.FC = () => {
  ...
  return (
    <div
      className={`fixed left-0 top-0 h-full w-64 transform bg-gradient-to-br from-[#c7e7f6] ${isOpen ? 'translate-x-0' : '-translate-x-full'} z-10 transition-transform duration-300 ease-in-out`}
    >
